...
final void Function(Pointer<Uint8>, Pointer<Uint8>) pubkeyFunc = 
  dyLib.lookup<NativeFunction<publickey_func>>('dart_publickey').asFunction<Publickey>();
...
final void Function(Pointer<Uint8>, Pointer<Uint8>, int) privkeyFunc = 
  dyLib.lookup<NativeFunction<privatekey_func>>('dart_privatekey').asFunction<Privatekey>();
...
final int Function(Pointer<Uint8>, int, Pointer<Uint8>, Pointer<Uint8>) verifyFunc = 
  dyLib.lookup<NativeFunction<verify_func>>('dart_validate_sig').asFunction<Verify>();
